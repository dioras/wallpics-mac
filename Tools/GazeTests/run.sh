...
cd "$(dirname "$0")"
P=../../WallpicsMac
SRC="main.swift Fixtures.swift $P/Pets/Render/GazeMap.swift $P/Pets/Core/PetModels.swift $P/Pets/Core/PetDIY.swift $P/Models/SubscriptionState.swift $P/Models/WallpaperAccess.swift $P/Services/LockScreenIndex.swift"
